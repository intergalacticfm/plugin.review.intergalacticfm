...
for key, values in sorted(streams.items()):
    ...
    markdown.write('![Poster](../plugin.video.intergalacticfm/resources/{}-poster.png "Poster")\n\n'.format(key))
    markdown.write('**Fanart** (1920 x 1080 JPG, only for background):\n')
    markdown.write('![Fanart](../plugin.video.intergalacticfm/resources/{}-fanart.jpg "Fanart")\n\n'.format(key))
    markdown.write('**Clear logo** (810 x 310 PNG with transparency):\n')
    markdown.write('![Clear logo](clearlogo-examples/{}-clearlogo.png "Fanart")\n\n'.format(key))
